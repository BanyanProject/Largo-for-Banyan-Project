...
the_post();
$rss_link =  get_term_feed_link(get_queried_object_id(),'series');
...
<?php if ( $opt['header_enabled'] ) : ?>
	<section id="series-header" class="col-md-12">
	...
	<div id="series-main" class="row row-fluid clearfix">
<?php endif; ?>
...
<div id="content" class="col-md-<?php echo $content_span[ $opt['cftl_layout'] ]; ?> stories" role="main">
<?php
