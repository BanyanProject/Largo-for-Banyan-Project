<?php
/**
 * Description: Founding Membership Pledge Form
 */
...
class FoundingMembershipPledgeForm extends FormSubmission {
...
if (is_array($_POST) && $_POST['submitted'] === '1') {
	...
	$form = new FoundingMembershipPledgeForm;
		...
		while ( have_posts() ) : the_post();
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
				...
				<section class="entry-content">
					...
					<form action="<?php the_permalink(); ?>" method="post" id="founding-membership-pledge-form">
